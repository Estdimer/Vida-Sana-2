...
public class RegistroEjercicios extends javax.swing.JFrame {
    ...
    public RegistroEjercicios(Perfil p) {
        usser = p.getUsuario();
    ...
    private void registrarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarButtonActionPerformed
        ...
        Ejercicio eje = new Ejercicio(nombre,repeticiones,fecha,usser,pass);
        ...
        File f = new File("./Ejercicios.csv");
            try(FileWriter fw = new FileWriter(f)){
                for(Ejercicio e: ControladorEjercicios.ejercicios)
                    fw.write(e.toCSV()+"\n");
        } catch(Exception e){
